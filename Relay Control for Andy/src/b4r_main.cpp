...
//******************************************* ANDY, CHANGE THE SETTINGS HERE *********************************************************************
b4r_main::_wifissid = be_gann15_5.wrap(""); // [Enter WiFi SSID/network name here]
b4r_main::_wifipassword = be_gann16_5.wrap(""); // [Enter WiFi password here]
