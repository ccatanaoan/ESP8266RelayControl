...
B4R::Common::LogHelper(1,102,F("AppStart"));
 //BA.debugLineNum = 47;BA.debugLine="RunNative(\"SetAPSTA\", Null)";
Common_RunNative(SetAPSTA,Common_Null);
 //BA.debugLineNum = 48;BA.debugLine="WiFiServer.Start";
b4r_main::_wifiserver->_start();
 //BA.debugLineNum = 50;BA.debugLine="d6.Initialize(d1pins.D6, d6.MODE_OUTPUT)";
b4r_main::_d6->Initialize(b4r_main::_d1pins->D6,Pin_MODE_OUTPUT);
 //BA.debugLineNum = 51;BA.debugLine="pin16.Initialize(16, pin16.MODE_OUTPUT)";
b4r_main::_pin16->Initialize((Byte) (16),Pin_MODE_OUTPUT);
 //BA.debugLineNum = 52;BA.debugLine="pin16.DigitalWrite(True)";
b4r_main::_pin16->DigitalWrite(Common_True);
 //BA.debugLineNum = 55;BA.debugLine="ReadFromEEPROM";
_readfromeeprom();
 //BA.debugLineNum = 57;BA.debugLine="IsWiFIConnectingAppStart = True";
...
const UInt cp = B4R::StackMemory::cp;
UInt _i = 0;
Byte be_ann231_9e1[1];
B4R::Array be_ann231_9e2;
 //BA.debugLineNum = 272;BA.debugLine="Sub ClearEEPROM 'ignore";
 //BA.debugLineNum = 273;BA.debugLine="Dim i As UInt";
_i = 0;
 //BA.debugLineNum = 275;BA.debugLine="Log(\"Size: \", eeprom.Size, \" bytes\")";
B4R::Common::LogHelper(3,102,F("Size: "),4,b4r_main::_eeprom->getSize(),102,F(" bytes"));
 //BA.debugLineNum = 276;BA.debugLine="For i = 0 To eeprom.Size";
{
const int step3 = 1;
const int limit3 = b4r_main::_eeprom->getSize();
_i = (UInt) (0) ;
for (;(step3 > 0 && _i <= limit3) || (step3 < 0 && _i >= limit3) ;_i = ((UInt)(0 + _i + step3))  ) {
 //BA.debugLineNum = 277;BA.debugLine="eeprom.WriteBytes(Array As Byte(0), i)";
b4r_main::_eeprom->WriteBytes(be_ann231_9e2.create(be_ann231_9e1,1,1,(Byte) (0)),_i);
 //BA.debugLineNum = 278;BA.debugLine="Log(i)";
...
const UInt cp = B4R::StackMemory::cp;
 //BA.debugLineNum = 289;BA.debugLine="Public Sub ConnectToNetwork";
 //BA.debugLineNum = 290;BA.debugLine="Log(\"Restarting controller\")";
B4R::Common::LogHelper(1,102,F("Restarting controller"));
 //BA.debugLineNum = 291;BA.debugLine="ESP.Restart";
...
B4R::B4RString* _clientid = B4R::B4RString::EMPTY;
 ...
 //BA.debugLineNum = 181;BA.debugLine="Log(\"ConnectToWifi\")";
B4R::Common::LogHelper(1,102,F("ConnectToWifi"));
 //BA.debugLineNum = 182;BA.debugLine="Dim SSID As String";
_ssid = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 183;BA.debugLine="Dim password As String";
_password = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 185;BA.debugLine="SSID = bc.StringFromBytes(GlobalStore.Slot0)";
_ssid = b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot0);
 //BA.debugLineNum = 186;BA.debugLine="If SSID.Length = 0 Then";
if (_ssid->getLength()==0) { 
 //BA.debugLineNum = 187;BA.debugLine="SSID = WiFiSSID";
_ssid = b4r_main::_wifissid;
 //BA.debugLineNum = 188;BA.debugLine="GlobalStore.Put(0,SSID)";
b4r_main::_globalstore->_put(0,(_ssid)->GetBytes());
 //BA.debugLineNum = 189;BA.debugLine="WriteToEEPROM(bc.StringFromBytes(GlobalStore.Slo";
_writetoeeprom(b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot0),b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot1),b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot2),b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot3));
 ...
 //BA.debugLineNum = 192;BA.debugLine="password = bc.StringFromBytes(GlobalStore.Slot1)";
_password = b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot1);
 //BA.debugLineNum = 193;BA.debugLine="If password.Length = 0 Then";
if (_password->getLength()==0) { 
 //BA.debugLineNum = 194;BA.debugLine="password = WiFiPassword";
_password = b4r_main::_wifipassword;
 //BA.debugLineNum = 195;BA.debugLine="GlobalStore.Put(1,password)";
b4r_main::_globalstore->_put(1,(_password)->GetBytes());
 //BA.debugLineNum = 196;BA.debugLine="WriteToEEPROM(bc.StringFromBytes(GlobalStore.Slo";
_writetoeeprom(b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot0),b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot1),b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot2),b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot3));
 };
 //BA.debugLineNum = 199;BA.debugLine="Timer2.Initialize(\"Timer2_Tick\", 50) '1000ms = 1";
b4r_main::_timer2->Initialize(_timer2_tick,(ULong) (50));
 //BA.debugLineNum = 200;BA.debugLine="Timer2.Enabled = True";
b4r_main::_timer2->setEnabled(Common_True);
 //BA.debugLineNum = 202;BA.debugLine="WiFi.Connect2(SSID, password)";
b4r_main::_wifi->Connect2(_ssid,_password);
 //BA.debugLineNum = 203;BA.debugLine="Timer2.Enabled = False";
b4r_main::_timer2->setEnabled(Common_False);
 //BA.debugLineNum = 205;BA.debugLine="If WiFi.IsConnected Then";
if (b4r_main::_wifi->getIsConnected()) { 
 //BA.debugLineNum = 207;BA.debugLine="Timer1.Enabled = False";
b4r_main::_timer1->setEnabled(Common_False);
 //BA.debugLineNum = 208;BA.debugLine="counter = 0";
b4r_main::_counter = (ULong) (0);
 //BA.debugLineNum = 209;BA.debugLine="Log(\"Connected to WiFi = \",SSID,\", Local IP = \",";
B4R::Common::LogHelper(6,102,F("Connected to WiFi = "),101,_ssid->data,102,F(", Local IP = "),101,b4r_main::_wifi->getLocalIp()->data,102,F(", Password = "),101,_password->data);
 //BA.debugLineNum = 211;BA.debugLine="Dim ClientId As String = Rnd(0, 999999999) 'crea";
_clientid = B4R::B4RString::fromNumber((Long)(Common_Rnd((Long) (0),(Long) (999999999))));
 //BA.debugLineNum = 212;BA.debugLine="MQTT.Initialize2(WiFiStr.stream, MQTTHostName, M";
b4r_main::_mqtt->Initialize2(b4r_main::_wifistr->getStream(),b4r_main::_mqtthostname,(UInt) (b4r_main::_mqttport),_clientid,_mqtt_messagearrived,_mqtt_disconnected);
 //BA.debugLineNum = 213;BA.debugLine="MQTTOpt.Initialize(MQTTUser, MQTTPassword)";
b4r_main::_mqttopt->Initialize(b4r_main::_mqttuser,b4r_main::_mqttpassword);
 //BA.debugLineNum = 214;BA.debugLine="MQTT_Connect(0)";
_mqtt_connect((Byte) (0));
 }else {
 //BA.debugLineNum = 216;BA.debugLine="Log(\"Failed to connect to \",SSID, \" WiFi\")";
B4R::Common::LogHelper(3,102,F("Failed to connect to "),101,_ssid->data,102,F(" WiFi"));
 };
 //BA.debugLineNum = 219;BA.debugLine="End Sub";
B4R::StackMemory::cp = cp;
}
Byte b4r_main::_getstoreddatalength(){
const UInt cp = B4R::StackMemory::cp;
B4R::Array* _header = NULL;
 //BA.debugLineNum = 351;BA.debugLine="Public Sub GetStoredDataLength As Byte";
 //BA.debugLineNum = 352;BA.debugLine="Dim header() As Byte = eeprom.ReadBytes(0, 2)";
_header = b4r_main::_eeprom->ReadBytes((UInt) (0),(UInt) (2));
 //BA.debugLineNum = 353;BA.debugLine="If header(0) = MAGIC_EEPROM Then";
if (((Byte*)_header->getData((UInt) (0)))[B4R::Array::staticIndex]==b4r_main::_magic_eeprom) { 
 //BA.debugLineNum = 354;BA.debugLine="Return header(1)";
B4R::StackMemory::cp = cp;
if (true) return ((Byte*)_header->getData((UInt) (1)))[B4R::Array::staticIndex];
 };
...
Int _c = 0;
B4R::Array* _s = NULL;
B4R::B4RString be_ann270_13;
B4R::B4RString be_ann286_4;
B4R::B4RString be_ann286_6;
B4R::B4RString be_ann290_4;
B4R::B4RString be_ann290_6;
B4R::Object be_ann293_6;
B4R::Object be_ann293_12;
B4R::Object be_ann293_18;
B4R::Object be_ann293_24;
 //BA.debugLineNum = 321;BA.debugLine="Private Sub MQTTChangeSetting(message() As Byte)";
 //BA.debugLineNum = 322;BA.debugLine="Dim c As Int";
_c = 0;
 //BA.debugLineNum = 323;BA.debugLine="For Each s() As Byte In bc.Split(message, \"|\")";
B4R::Iterator* group2 = b4r_main::_bc->Split(_message,(be_ann270_13.wrap("|"))->GetBytes());
while (group2->MoveNext()) {
_s = (B4R::Array*)B4R::Object::toPointer(group2->Get());
 //BA.debugLineNum = 324;BA.debugLine="If c = 0 Then";
if (_c==0) { 
 //BA.debugLineNum = 325;BA.debugLine="GlobalStore.Put(0,s) ' SSID";
b4r_main::_globalstore->_put(0,_s);
 };
 //BA.debugLineNum = 327;BA.debugLine="If c = 1 Then";
if (_c==1) { 
 //BA.debugLineNum = 328;BA.debugLine="GlobalStore.Put(1,s) ' Password";
b4r_main::_globalstore->_put(1,_s);
 };
 //BA.debugLineNum = 330;BA.debugLine="If c = 2 Then";
if (_c==2) { 
 //BA.debugLineNum = 331;BA.debugLine="GlobalStore.Put(2,s) ' Open delay";
b4r_main::_globalstore->_put(2,_s);
 };
 //BA.debugLineNum = 333;BA.debugLine="If c = 3 Then";
if (_c==3) { 
 //BA.debugLineNum = 334;BA.debugLine="GlobalStore.Put(3,s) ' Closed delay";
b4r_main::_globalstore->_put(3,_s);
 };
 //BA.debugLineNum = 336;BA.debugLine="c = c + 1";
_c = (Int) (_c+1);
 }
;
 //BA.debugLineNum = 338;BA.debugLine="If IsNumber(bc.StringFromBytes(GlobalStore.Slot2)";
if (B4R::__c->IsNumber(b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot2))==Common_False || b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot2)->getLength()==0) { 
 //BA.debugLineNum = 339;BA.debugLine="MQTT.Publish(\"Andy\",\"*Open delay value is invali";
b4r_main::_mqtt->Publish(be_ann286_4.wrap("Andy"),(be_ann286_6.wrap("*Open delay value is invalid!"))->GetBytes());
 //BA.debugLineNum = 340;BA.debugLine="Return";
B4R::StackMemory::cp = cp;
if (true) return ;
 };
 //BA.debugLineNum = 342;BA.debugLine="If IsNumber(bc.StringFromBytes(GlobalStore.Slot3)";
if (B4R::__c->IsNumber(b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot3))==Common_False || b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot3)->getLength()==0) { 
 //BA.debugLineNum = 343;BA.debugLine="MQTT.Publish(\"Andy\",\"*Closed delay value is inva";
b4r_main::_mqtt->Publish(be_ann290_4.wrap("Andy"),(be_ann290_6.wrap("*Closed delay value is invalid!"))->GetBytes());
 //BA.debugLineNum = 344;BA.debugLine="Return";
B4R::StackMemory::cp = cp;
if (true) return ;
 };
 //BA.debugLineNum = 346;BA.debugLine="Log(\"MQTTChangeSetting.Slot0: \",GlobalStore.Slot0";
B4R::Common::LogHelper(8,102,F("MQTTChangeSetting.Slot0: "),100,be_ann293_6.wrapPointer(b4r_main::_globalstore->_slot0),102,F(" GlobalStore.Slot1: "),100,be_ann293_12.wrapPointer(b4r_main::_globalstore->_slot1),102,F(" GlobalStore.Slot2: "),100,be_ann293_18.wrapPointer(b4r_main::_globalstore->_slot2),102,F(" GlobalStore.Slot3: "),100,be_ann293_24.wrapPointer(b4r_main::_globalstore->_slot3));
 //BA.debugLineNum = 347;BA.debugLine="WriteToEEPROM(bc.StringFromBytes(GlobalStore.Slot";
_writetoeeprom(b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot0),b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot1),b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot2),b4r_main::_bc->StringFromBytes(b4r_main::_globalstore->_slot3));
 //BA.debugLineNum = 348;BA.debugLine="ConnectToNetwork";
_connecttonetwork();
...
b4r_main::_relaycloseddelay = be_gann18_5.wrap("15000");
 //BA.debugLineNum = 29;BA.debugLine="Public eeprom As EEPROM";
...
Byte be_ann198_16e1[1];
B4R::Array be_ann198_16e2;
Int _i = 0;
B4R::Array* _objects = NULL;
B4R::B4RString be_ann209_8;
B4R::B4RString* _ssid = B4R::B4RString::EMPTY;
B4R::B4RString be_ann210_8;
B4R::B4RString* _password = B4R::B4RString::EMPTY;
...
B4R::Object be_ann217_8;
B4R::Object be_ann217_14;
B4R::Object be_ann217_20;
B4R::Object be_ann217_26;
 //BA.debugLineNum = 235;BA.debugLine="Sub ReadFromEEPROM";
 //BA.debugLineNum = 236;BA.debugLine="Log(\"Reading settings from the EEPROM\")";
B4R::Common::LogHelper(1,102,F("Reading settings from the EEPROM"));
 //BA.debugLineNum = 238;BA.debugLine="Dim header() As Byte = eeprom.ReadBytes(0, 2)";
_header = b4r_main::_eeprom->ReadBytes((UInt) (0),(UInt) (2));
 //BA.debugLineNum = 239;BA.debugLine="If header(0) = MAGIC_EEPROM Then";
if (((Byte*)_header->getData((UInt) (0)))[B4R::Array::staticIndex]==b4r_main::_magic_eeprom) { 
 //BA.debugLineNum = 240;BA.debugLine="Dim data() As Byte = eeprom.ReadBytes(2, header(";
_data = b4r_main::_eeprom->ReadBytes((UInt) (2),(UInt) (((Byte*)_header->getData((UInt) (1)))[B4R::Array::staticIndex]));
 //BA.debugLineNum = 241;BA.debugLine="Dim i As Int = bc.IndexOf(data, Array As Byte(0)";
_i = b4r_main::_bc->IndexOf(_data,be_ann198_16e2.create(be_ann198_16e1,1,1,(Byte) (0)));
 //BA.debugLineNum = 242;BA.debugLine="If i = -1 Then";
if (_i==-1) { 
 //BA.debugLineNum = 243;BA.debugLine="Log(\"Error parsing settings. Starting as an acc";
...
b4r_main::_wifi->Disconnect();
 //BA.debugLineNum = 245;BA.debugLine="IsWiFIConnectingAppStart = True";
b4r_main::_iswificonnectingappstart = Common_True;
 //BA.debugLineNum = 246;BA.debugLine="Timer1.Initialize(\"Timer1_Tick\", 1000) '1000ms";
b4r_main::_timer1->Initialize(_timer1_tick,(ULong) (1000));
 //BA.debugLineNum = 247;BA.debugLine="Timer1.Enabled = True";
b4r_main::_timer1->setEnabled(Common_True);
 //BA.debugLineNum = 248;BA.debugLine="WiFiServer.Start";
b4r_main::_wifiserver->_start();
 //BA.debugLineNum = 249;BA.debugLine="Return";
B4R::StackMemory::cp = cp;
if (true) return ;
 };
 //BA.debugLineNum = 251;BA.debugLine="Dim Objects() As Object = ser.ConvertBytesToArra";
_objects = b4r_main::_ser->ConvertBytesToArray(_data,b4r_main::_objectsbuffer);
 //BA.debugLineNum = 252;BA.debugLine="Dim SSID As String = Objects(0) 'ignore";
_ssid = be_ann209_8.wrap((const char*)B4R::Object::toPointer(((B4R::Object**)_objects->getData((UInt) (0)))[B4R::Array::staticIndex]));
 //BA.debugLineNum = 253;BA.debugLine="Dim Password As String = Objects(1) 'ignore";
_password = be_ann210_8.wrap((const char*)B4R::Object::toPointer(((B4R::Object**)_objects->getData((UInt) (1)))[B4R::Array::staticIndex]));
 //BA.debugLineNum = 254;BA.debugLine="Dim OpenDelay As String = Objects(2) 'ignore";
_opendelay = be_ann211_8.wrap((const char*)B4R::Object::toPointer(((B4R::Object**)_objects->getData((UInt) (2)))[B4R::Array::staticIndex]));
 //BA.debugLineNum = 255;BA.debugLine="Dim ClosedDelay As String = Objects(3) 'ignore";
_closeddelay = be_ann212_8.wrap((const char*)B4R::Object::toPointer(((B4R::Object**)_objects->getData((UInt) (3)))[B4R::Array::staticIndex]));
 //BA.debugLineNum = 256;BA.debugLine="GlobalStore.Put(0,SSID) ' SSID";
b4r_main::_globalstore->_put(0,(_ssid)->GetBytes());
 //BA.debugLineNum = 257;BA.debugLine="GlobalStore.Put(1,Password) ' Password";
b4r_main::_globalstore->_put(1,(_password)->GetBytes());
 //BA.debugLineNum = 258;BA.debugLine="GlobalStore.Put(2,OpenDelay) ' Open delay";
b4r_main::_globalstore->_put(2,(_opendelay)->GetBytes());
 //BA.debugLineNum = 259;BA.debugLine="GlobalStore.Put(3,ClosedDelay) ' Closed delay";
b4r_main::_globalstore->_put(3,(_closeddelay)->GetBytes());
 //BA.debugLineNum = 260;BA.debugLine="Log(\"ReadFromEEPROM \",\" Slot0: \",GlobalStore.Slo";
B4R::Common::LogHelper(9,102,F("ReadFromEEPROM "),102,F(" Slot0: "),100,be_ann217_8.wrapPointer(b4r_main::_globalstore->_slot0),102,F(" Slot1: "),100,be_ann217_14.wrapPointer(b4r_main::_globalstore->_slot1),102,F(" Slot2: "),100,be_ann217_20.wrapPointer(b4r_main::_globalstore->_slot2),102,F(" Slot3: "),100,be_ann217_26.wrapPointer(b4r_main::_globalstore->_slot3));
 }else {
 //BA.debugLineNum = 262;BA.debugLine="Log(\"Settings data not found. Starting as an acc";
B4R::Common::LogHelper(1,102,F("Settings data not found. Starting as an access point."));
 //BA.debugLineNum = 263;BA.debugLine="WiFi.Disconnect";
b4r_main::_wifi->Disconnect();
 //BA.debugLineNum = 264;BA.debugLine="IsWiFIConnectingAppStart = True";
b4r_main::_iswificonnectingappstart = Common_True;
 //BA.debugLineNum = 265;BA.debugLine="Timer1.Initialize(\"Timer1_Tick\", 1000) '1000ms =";
b4r_main::_timer1->Initialize(_timer1_tick,(ULong) (1000));
 //BA.debugLineNum = 266;BA.debugLine="Timer1.Enabled = True";
b4r_main::_timer1->setEnabled(Common_True);
 //BA.debugLineNum = 267;BA.debugLine="WiFiServer.Start";
b4r_main::_wifiserver->_start();
 };
...
void b4r_main::_savenetworkdetails(B4R::Array* _data){
const UInt cp = B4R::StackMemory::cp;
Byte be_ann236_13e1[2];
B4R::Array be_ann236_13e2;
 //BA.debugLineNum = 282;BA.debugLine="Public Sub SaveNetworkDetails(Data() As Byte)";
 //BA.debugLineNum = 283;BA.debugLine="eeprom.WriteBytes(Array As Byte(MAGIC_EEPROM, Dat";
b4r_main::_eeprom->WriteBytes(be_ann236_13e2.create(be_ann236_13e1,2,1,b4r_main::_magic_eeprom,(Byte) (_data->length)),(UInt) (0));
 //BA.debugLineNum = 284;BA.debugLine="eeprom.WriteBytes(Data, 2)";
b4r_main::_eeprom->WriteBytes(_data,(UInt) (2));
 //BA.debugLineNum = 285;BA.debugLine="Delay(1000)";
Common_Delay((ULong) (1000));
 //BA.debugLineNum = 286;BA.debugLine="ConnectToNetwork";
_connecttonetwork();
...
bool _newstate = false;
 //BA.debugLineNum = 294;BA.debugLine="Private Sub Timer1_Tick";
 //BA.debugLineNum = 296;BA.debugLine="counter = counter + 1";
b4r_main::_counter = (ULong) (b4r_main::_counter+1);
 //BA.debugLineNum = 297;BA.debugLine="If counter >= 300 Then";
if (b4r_main::_counter>=300) { 
 //BA.debugLineNum = 298;BA.debugLine="IsWiFIConnectingAppStart = True";
b4r_main::_iswificonnectingappstart = Common_True;
 //BA.debugLineNum = 299;BA.debugLine="ConnectToWifi";
_connecttowifi();
 //BA.debugLineNum = 300;BA.debugLine="If WiFi.IsConnected Then";
if (b4r_main::_wifi->getIsConnected()) { 
 //BA.debugLineNum = 301;BA.debugLine="Timer1.Enabled = False";
b4r_main::_timer1->setEnabled(Common_False);
 //BA.debugLineNum = 302;BA.debugLine="IsWiFIConnectingAppStart = False";
b4r_main::_iswificonnectingappstart = Common_False;
 }else {
 //BA.debugLineNum = 304;BA.debugLine="Log(\"Starting as an access point.\")";
B4R::Common::LogHelper(1,102,F("Starting as an access point."));
 //BA.debugLineNum = 305;BA.debugLine="Timer1.Initialize(\"Timer1_Tick\", 1000) '1000ms";
b4r_main::_timer1->Initialize(_timer1_tick,(ULong) (1000));
 //BA.debugLineNum = 306;BA.debugLine="Timer1.Enabled = True";
b4r_main::_timer1->setEnabled(Common_True);
 //BA.debugLineNum = 307;BA.debugLine="WiFiServer.Start";
b4r_main::_wifiserver->_start();
 };
 //BA.debugLineNum = 309;BA.debugLine="counter = 0";
b4r_main::_counter = (ULong) (0);
 };
 //BA.debugLineNum = 311;BA.debugLine="Dim currentState As Boolean = pin16.DigitalRead";
_currentstate = b4r_main::_pin16->DigitalRead();
 //BA.debugLineNum = 312;BA.debugLine="Dim NewState As Boolean = Not(currentState)";
_newstate = Common_Not(_currentstate);
 //BA.debugLineNum = 313;BA.debugLine="pin16.DigitalWrite(NewState)";
...
const UInt cp = B4R::StackMemory::cp;
 //BA.debugLineNum = 316;BA.debugLine="Private Sub Timer2_Tick";
 //BA.debugLineNum = 318;BA.debugLine="Log(\"\")";
...
const UInt cp = B4R::StackMemory::cp;
B4R::Object be_ann187_10;
B4R::Object be_ann187_12;
B4R::Object be_ann187_14;
B4R::Object be_ann187_16;
B4R::Object* be_ann187_17e1[4];
B4R::Array be_ann187_17e2;
B4R::Array* _listofobjectstostore = NULL;
Byte be_ann188_4e1[0];
B4R::Array be_ann188_4e2;
B4R::Array* _bytedatatostore = NULL;
Byte be_ann190_13e1[2];
B4R::Array be_ann190_13e2;
 //BA.debugLineNum = 221;BA.debugLine="Sub WriteToEEPROM(SSID As String, Password As Stri";
 //BA.debugLineNum = 222;BA.debugLine="Log(\"Writing setiings into the EEPROM\")";
B4R::Common::LogHelper(1,102,F("Writing setiings into the EEPROM"));
 //BA.debugLineNum = 223;BA.debugLine="Dim ListOfObjectsToStore() As Object = Array(SSID";
_listofobjectstostore = be_ann187_17e2.create(be_ann187_17e1,4,100,be_ann187_10.wrapPointer(_ssid->data),be_ann187_12.wrapPointer(_password->data),be_ann187_14.wrapPointer(_opendelay->data),be_ann187_16.wrapPointer(_closeddelay->data));
 //BA.debugLineNum = 224;BA.debugLine="Dim ByteDataToStore() As Byte";
_bytedatatostore =be_ann188_4e2.wrap(be_ann188_4e1,0);
 //BA.debugLineNum = 227;BA.debugLine="ByteDataToStore = ser.ConvertArrayToBytes(ListOfO";
_bytedatatostore = b4r_main::_ser->ConvertArrayToBytes(_listofobjectstostore);
 //BA.debugLineNum = 230;BA.debugLine="eeprom.WriteBytes(Array As Byte(MAGIC_EEPROM, Byt";
b4r_main::_eeprom->WriteBytes(be_ann190_13e2.create(be_ann190_13e1,2,1,b4r_main::_magic_eeprom,(Byte) (_bytedatatostore->length)),(UInt) (0));
 //BA.debugLineNum = 232;BA.debugLine="eeprom.WriteBytes(ByteDataToStore, 2)";
