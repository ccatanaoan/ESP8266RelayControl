...
b4r_main::_mqtt->Subscribe(be_ann37_4.wrap("Andy"),(Byte) (0));
 };
...
B4R::Common::LogHelper(4,102,F("Message arrived. Topic="),101,_topic->data,102,F(" Payload="),100,be_ann66_8.wrapPointer(_payload));
 //BA.debugLineNum = 103;BA.debugLine="If Payload=\"Remotely close relay\" Then";
if ((_payload)->equals((be_ann67_3.wrap("Remotely close relay"))->GetBytes())) { 
 //BA.debugLineNum = 104;BA.debugLine="MQTT.Publish(\"Andy\",\"*Closing relay by remote\")";
b4r_main::_mqtt->Publish(be_ann68_4.wrap("Andy"),(be_ann68_6.wrap("*Closing relay by remote"))->GetBytes());
...
b4r_main::_stoprelay = Common_True;
 }else if((_payload)->equals((be_ann71_3.wrap("Remotely open relay"))->GetBytes())) { 
 //BA.debugLineNum = 108;BA.debugLine="MQTT.Publish(\"Andy\",\"*Opening relay by remote\")";
b4r_main::_mqtt->Publish(be_ann72_4.wrap("Andy"),(be_ann72_6.wrap("*Opening relay by remote"))->GetBytes());
...
_relayopen((Byte) (0));
 }else if((_payload)->equals((be_ann75_3.wrap("Restart controller"))->GetBytes())) { 
 //BA.debugLineNum = 112;BA.debugLine="MQTT.Publish(\"Andy\",\"*Restarting relay by remote";
b4r_main::_mqtt->Publish(be_ann76_4.wrap("Andy"),(be_ann76_6.wrap("*Restarting relay by remote"))->GetBytes());
...
B4R::B4RString be_ann48_6;
 //BA.debugLineNum = 74;BA.debugLine="Private Sub RelayClose (tag As Byte)";
 //BA.debugLineNum = 75;BA.debugLine="If StopRelay Then";
if (b4r_main::_stoprelay) { 
...
b4r_main::_mqtt->Publish(be_ann48_4.wrap("Andy"),(be_ann48_6.wrap("*Relay has been closed"))->GetBytes());
 //BA.debugLineNum = 83;BA.debugLine="d6.DigitalWrite(True)";
b4r_main::_d6->DigitalWrite(Common_True);
 //BA.debugLineNum = 84;BA.debugLine="CallSubPlus(\"RelayOpen\", 15000, 0)";
...
B4R::B4RString be_ann60_6;
 ...
 //BA.debugLineNum = 88;BA.debugLine="If StopRelay Then";
if (b4r_main::_stoprelay) { 
...
b4r_main::_mqtt->Publish(be_ann60_4.wrap("Andy"),(be_ann60_6.wrap("*Relay has been opened"))->GetBytes());
 //BA.debugLineNum = 96;BA.debugLine="d6.DigitalWrite(False)";
b4r_main::_d6->DigitalWrite(Common_False);
 //BA.debugLineNum = 97;BA.debugLine="CallSubPlus(\"RelayClose\", 5000, 0)";
